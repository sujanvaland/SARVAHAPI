...
namespace SpiritualNetwork.API.Services
{
    public class AttachmentService : IAttachmentService
    {
        ...
        public string UploadImagesToFtp(IFormFile imgfile, string filename, string ftpServerUrl= "ftp://45.114.245.207", string ftpUsername = "k4m2a.co_dv2lwekpooa", string ftpPassword= "^D$1R6mejsq9zcPf", string remoteDirectory = "httpdocs/post/images")
        {
            try
            {
        ...
        public async Task<List<Entities.File>> InsertAttachment(List<IFormFile> reqfilearr)
        {
            try
            {
                ...
                foreach (var item in reqfilearr)
                {
                    ...
                    file.ThumbnailUrl = "https://www.k4m2a.com/post/images/" + tempfilename;
                    file.ActualUrl = "https://www.k4m2a.com/post/images/" + tempfilename;
                    filearr.Add(file);
                }
